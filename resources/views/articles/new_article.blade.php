    ...
    <x-slot name="header">
        ...
        <div class="grid grid-cols-2 w-full">
            ...
            <div class="text-right w-full">
                ...
                <a href="/articles" class="px-4 py-2 bg-gray-400 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition">Zamknij</a>           
            </div>
        </div>        
    </x-slot>
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                @csrf
                    ...
                    <div class="col-span-full">
                        ...
                        <input class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full" id="title" type="text" autocomplete="title" name="tytul">
                    </div>
                    ...
                    <div class="col-span-full">
                        ...
                        <input class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full" id="keywords" type="text" autocomplete="keywords" name="keywords">
                    </div>    
                    ...
                    <div class="col-span-full">
                        ...
                        <x-forms.ckeditor-new id="editor1" name="zajawka" type="h-96 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full" />
                    </div>
                    ...
                    <div class="col-span-full">
                        ...
                        <x-forms.ckeditor-new id="editor2" name="tresc" type="h-96 border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm mt-1 block w-full" />
                    </div>
                </div>
            </div>
