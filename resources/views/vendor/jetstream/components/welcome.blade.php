<div class="p-6 sm:px-20 bg-white text-center">
    <div class="mt-8 text-2xl content-center">
        Witaj {{ Auth::user()->name }}
    </div>

    <div class="mt-6 text-gray-500 content-center">
        w nowym panelu administracyjny <br><a href="https://www.przemysl24.pl" class="underline" target="_blank">www.przemysl24.pl</a> 
    </div>
</div>
<div class="content-center">
        <x-jet-application-logo class="h-12 content-center" />
</div>
